            ...
            >
              <g id="scene">
                ...
                <path
                  ...
                  id="rug"
                  style={{ fill: colors.rug.rug }}
                  fillRule="nonzero"
                />
                <polygon
                  id="wall-right"
                  style={{ fill: colors.walls.wallSide }}
                  fillRule="nonzero"
                ...
                <g
                  ...
                  style={{ fill: colors.table.lampShadow }}
                  fillRule="nonzero"
                >
                  <rect
                ...
                <polyline
                  id="wall-back"
                  style={{ fill: colors.walls.wallBack }}
                  fillRule="nonzero"
                ...
                >
                  <rect
                    id="window-frame"
                    style={{ fill: colors.window.windowFrame }}
                    x="0"
                    y="0"
                    width="382"
                    height="275"
                  ...
                  >
                    ...
                    <path
                      ...
                      style={{ fill: colors.window.windowPane }}
                    />
                    <path
                ...
                <g id="bed" transform="translate(532.000000, 247.000000)">
                  <path
                    ...
                    id="bed-shadow"
                    style={{ fill: colors.bed.bedShadowDark }}
                    fillRule="nonzero"
                  />
                  <g
                    id="bed-backboard"
                  ...
                  >
                    <path
                      ...
                      style={{ fill: colors.bed.backboardShadow }}
                    />
                    <path
                      ...
                      style={{ fill: colors.bed.backboardFront }}
                    />
                  </g>
                  <path
                  ...
                  >
                    <path
                      ...
                      id="bed-mattress-top"
                      style={{ fill: colors.bed.mattressTop }}
                    />
                    <path
                      ...
                      style={{ fill: colors.bed.mattressFront }}
                    />
                  </g>
                  <path
                    ...
                    id="bed-pillow-back"
                    style={{ fill: colors.bed.pillowBack }}
                    fillRule="nonzero"
                  />
                  <path
                    ...
                    id="bed-pillow-front"
                    style={{ fill: colors.bed.pillowFront }}
                    fillRule="nonzero"
                  />
                  <g
                    id="bed-wrinkles"
                  ...
                  >
                    <path
                      ...
                      id="blanket-front"
                      style={{ fill: colors.bed.blanketFront }}
                      fillRule="nonzero"
                    />
                    <path
                      ...
                      id="blanket-top"
                      style={{ fill: colors.bed.blanketTop }}
                      fillRule="nonzero"
                    />
                    <path
                      ...
                      id="bed-wrinkle-6"
                      style={{ stroke: colors.bed.bedWrinkles }}
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                    <path
                ...
                >
                  <rect
                    ...
                    style={{ fill: colors.table.tableBack }}
                    x="140"
                    y="23"
                    width="14"
                    height="95"
                  ...
                  <rect
                    ...
                    style={{ fill: colors.table.tableFront }}
                    x="16"
                    y="24"
                    width="19"
                    height="131"
                  ...
                  <polygon
                    id="table-top"
                    style={{ fill: colors.table.tableTop }}
                  ...
                  <path
                    ...
                    id="table-left"
                    style={{ fill: colors.table.tableLeft }}
                  />
                </g>
                <g
                  id="lamp"
                ...
                >
                  <g id="lamp-base" transform="translate(21.000000, 37.000000)">
                    <rect
                      id="lamp-base-pole"
                      style={{ fill: colors.table.lampBase }}
                      x="10"
                      y="9"
                      width="10"
                      height="48"
                  ...
                  <g
                    ...
                    style={{ fill: colors.table.lampString }}
                  >
                  ...
                  <g id="lamp-shade">
                    <path
                      ...
                      id="lamp-shade-front"
                      style={{ fill: colors.table.lampShade }}
                    />
                    <path
                ...
                >
                  <path
                    ...
                    id="dresser-front"
                    style={{ fill: colors.dresser.front }}
                  />
                  <path
                    ...
                    id="dresser-top"
                    style={{ fill: colors.dresser.topBorder }}
                  />
                  <rect
                  ...
                  <rect
                    id="dresser-drawer-3"
                    style={{ fill: colors.dresser.drawer }}
                    x="27"
                    y="45"
                    width="242"
                    height="40"
                  ...
                  <circle
                    id="dresser-knob-6"
                    style={{ fill: colors.dresser.knob }}
                    cx="62"
                    cy="65"
                    r="8"
                  />
                ...
                <g id="clock" transform="translate(960.000000, 53.000000)">
                  <circle
                    id="clock-frame"
                    style={{ fill: colors.decorations.frames }}
                    fillRule="nonzero"
                    cx="43.5"
                    cy="43.5"
                    r="43.5"
                  ...
                  <circle
                    id="clock-bg"
                    style={{ fill: colors.decorations.colorLight }}
                    fillRule="nonzero"
                    cx="43.5"
                    cy="43.5"
                    r="35.5"
                  ...
                  <polyline
                    id="clock-hands"
                    style={{ stroke: colors.decorations.colorDark }}
                    strokeWidth="3"
                ...
                >
                  ...
                  <rect
                    id="picture-bg"
                    style={{ fill: colors.decorations.pictureBg }}
                    x="10"
                    y="11"
                    width="231"
                    height="114"
                  ...
                  <path
                    ...
                    id="picture-3"
                    style={{ fill: colors.decorations.colorDark }}
                  />
                  <path
                  ...
                  <path
                    ...
                    id="picture-2"
                    style={{ fill: colors.decorations.colorMed }}
                  />
                </g>
              </g>
            </g>
